  ...
  return (
    <div className={SectionThreeStyle.sectionThree}>
      ...
      <Link href="./GuiaPasoApaso/InformacionImportante"><p className={SectionThreeStyle.letrasubrayada}>INFORMACIÓN IMPORTANTE</p></Link>
        <Link href="https://api.whatsapp.com/send?phone=56962201964"><p className={SectionThreeStyle.letrasubrayada}> SOLICÍTA TU MATERIAL</p></Link>
        <Link href="https://api.whatsapp.com/send?phone=56962201964"><p className={SectionThreeStyle.letrasubrayada}>SOLICÍTA INSTRUCCIONES</p></Link>
      ...
      <Link href="https://api.whatsapp.com/send?phone=56962201964" className={SectionThreeStyle.enlace}>
