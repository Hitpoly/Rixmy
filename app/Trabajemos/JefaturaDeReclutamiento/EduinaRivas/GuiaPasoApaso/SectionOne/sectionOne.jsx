  ...
  return (
    <div className={SectionThreeStyle.sectionThree}>
      ...
      <Link href="./GuiaPasoApaso/InformacionImportante"><p className={SectionThreeStyle.letrasubrayada}>INFORMACIÓN IMPORTANTE</p></Link>
        <Link href="https://bit.ly/3rJLt2A"><p className={SectionThreeStyle.letrasubrayada}>SOLICÍTA TU MATERIAL</p></Link>
        <Link href="https://bit.ly/46TTuRs"><p className={SectionThreeStyle.letrasubrayada}>SOLICÍTA INSTRUCCIONES</p></Link>
        <Link href="https://bit.ly/48TpqHg"><p className={SectionThreeStyle.letrasubrayada}>COMUNIDAD DE WHATSAPP</p></Link>
        <Link href="https://bit.ly/3ZXj05O"><p className={SectionThreeStyle.letrasubrayada}>COMUNIDAD DE FACEBOOK</p></Link> 
      </div>
      <Link href="https://api.whatsapp.com/send?phone=584261307275" className={SectionThreeStyle.enlace}>
