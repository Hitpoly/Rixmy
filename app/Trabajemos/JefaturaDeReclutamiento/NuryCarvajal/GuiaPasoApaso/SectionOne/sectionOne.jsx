  ...
  return (
    <div className={SectionThreeStyle.sectionThree}>
      ...
      <Link href="./GuiaPasoApaso/InformacionImportante"><p className={SectionThreeStyle.letrasubrayada}>INFORMACIÓN IMPORTANTE</p></Link>
        <Link href="https://wa.link/ktc9c4"><p className={SectionThreeStyle.letrasubrayada}> SOLICÍTA TU MATERIAL</p></Link>
        <Link href="https://wa.link/2tbwas"><p className={SectionThreeStyle.letrasubrayada}>SOLICÍTA INSTRUCCIONES</p></Link>
        <Link href="https://chat.whatsapp.com/CHyKvXKcW874JYuFRGXTCx"><p className={SectionThreeStyle.letrasubrayada}>COMUNIDAD DE WHATSAPP</p></Link>
        <Link href="https://www.facebook.com/groups/1389286465339961/?ref=share"><p className={SectionThreeStyle.letrasubrayada}>COMUNIDAD DE FACEBOOK</p></Link> 
      </div>
      <Link href="https://api.whatsapp.com/send?phone=573184989178" className={SectionThreeStyle.enlace}>
